...
\section[Hardware requirements for CWLFM signal processing]{Hardware requirements for generation and processing of CWLFM signals} \label{sec:general_hw_req}
