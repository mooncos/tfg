...
These peripherals work in conjunction with the software DSP to obtain the data to be sent via the wireless BLE link. The configuration of these peripherals performed in the firmware source code can be found in Appendix F. %TODO: ZZZ
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.6\linewidth]{gpio/gpio.png}
...
Additional details of the configuration of the GPIO pins can be found in Appendix G. % TODO: Appendix ZZZ
...
, the FFT size is set to 256, but the firmware source code allows for a simple modification of this parameter. The detailed implementation of the FFT algorithm in the firmware can be found in Appendix H. % TODO: A high-level diagram of the resulting frequency bins vector is found in Figure ZZZ.
...
\begin{figure}[ht]
	\centering
	\includegraphics{dsp/dsp_bitrate.pdf}
...
\begin{figure}[ht]
	\centering
	\includegraphics{dsp/dsp_time.pdf}
...
The application is programmed in the Python programming language. The application is provided with documentation (Appendix K) that allows for easy modification if necessary. It makes use of the libraries \textit{Bleak} \cite{BleakDoc} for handling the BLE connection and data reception, \textit{NumPy} \cite{NumPyDoc} for numerical processing and \textit{Qt} \cite{QtDoc} for the graphical user interface (GUI). Screenshots of the application GUI while in use can be found in \cref{fig:pc}. %TODO: references
...
\begin{figure}[htb]
	\centering
	\subfloat[Display of results of a reflective target in the primary operating mode]{\includegraphics[height=7.25cm]{img/gui_range.png} \label{fig:pc_range}}
	\subfloat[Display of results of a walking person capture in the secondary operating mode]{\includegraphics[height=7.25cm]{img/gui_gait.png} \label{fig:pc_gait}}
