...
\begin{enumerate}
	\item The MCU must have a small form factor of up to 1 cm by 1 cm. This is to guarantee a compact layout in the PCB when placing the integrated circuit (IC).
	\item 
\end{enumerate}
