...
The configuration of the PFD is performed by writing to specified registers via an SPI communication. The SPI communication is handled by a micro-controller unit (MCU) embedded into the PCB. This MCU is previously programmed with the configuration data for the registers of the PFD. The configuration of the PFD is carried out as described in \cite{Sardinero2022}.
