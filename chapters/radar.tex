...
\begin{enumerate}
	...
	\item The MCU must incorporate one or more wireless communication protocols capabilities built in. It is preferred that the protocol(s) are standard and widely used in Internet of Things devices such as WiFi or Bluetooth Low Energy (BLE) \cite{AlSarawi2017}.
	\item 
\end{enumerate}
