...
In addition to the IF signals, the baseband stage also outputs trigger signals to allow the ADC in the acquisition stage to determine the sampling start instant. The trigger signals are measured in conjunction with the intermediate frequency signals with an Agilent MS ZZZ oscilloscope and the data is captured. The measured ramps and trigger signals are shown in Figure ZZZ.
