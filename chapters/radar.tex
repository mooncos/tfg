...
\subsection{Voltage ramp at the input of the voltage controlled oscillator}  \label{sec:vco_characterisation}
...
It is necessary to discard approximately a 10\% of the samples during the phases where the PLL is unlocked and a dual ramp is present, as they do not provide information about the CWFM signals.
