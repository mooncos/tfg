...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{if_stage_sucio/prueba_impresion_ads.pdf} %TODO: cambiar
	\caption{Circuit of the IF stage signal conditioning step. \textit{V\_DC} is the DC-shift provided. The resistors of the feedback networks are responsible of setting the gain configuration. A low-value capacitance is placed at the ouput to provide the input of the ADC with a small amount of loading to reduce influence of high-frequency noise}
	\label{fig:if_cir}
\end{figure}
