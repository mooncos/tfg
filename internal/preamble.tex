...
%\makeglossaries
\usepackage[abbreviations,nonumberlist,toc=false,section=chapter]{glossaries-extra}
\makenoidxglossaries
\glsaddall
...
\usepackage[backend=biber, sorting=none, style=ieee, citestyle=numeric-comp]{biblatex}
\bibliography{ref/full.bib}

\usepackage{courier}
\usepackage{minted}
\newcommand{\ccode}[2]{\inputminted[obeytabs=true,tabsize=2,breaklines,label=#2,frame=topline,fontsize=\footnotesize]{c}{#1}}
...
\graphicspath{{img/}{fig/}{fig/intro}{ext_docs/}}
